...
function robotsNeverFallAtTheSamePointAndOrientationTest() {
    ...
    let robot2 = new Robot(1,1,'W',mars);
    ...
    console.assert(
        ...
        ,"Problems in test 1 of robotsNeverDropAtTheSamePointTest, Robot1 at (-1, -1) and Robot2 at (1, 1) was expected but received Robot1 at ("+robot1.xPos +", "+robot1.yPos +") and Robot2 at ("+robot2.xPos +", "+robot2.yPos +")");
